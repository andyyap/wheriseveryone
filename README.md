...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/wheriseveryone)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/wheriseveryone
```

A live public deployment of this template is available at [https://wheriseveryone.templates.workers.dev](https://wheriseveryone.templates.workers.dev)
